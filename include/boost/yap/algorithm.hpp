    ...
    namespace yap {
        ...
        namespace detail {
                ...
                IsLvalueRef>
            {
                ...
                {
                    return ::boost::yap::detail::value_impl<
                        ValueOfTerminalsOnly>(
            ...
            struct value_impl_t
            {
                decltype(auto) operator()(T && x)
                {
                    ...
                    constexpr detail::expr_arity arity =
        ...
        */
        ...
        {
            return ::boost::yap::get(
                static_cast<Expr &&>(expr), hana::llong_c<0>);
            constexpr expr_kind kind = detail::remove_cv_ref_t<Expr>::kind;
            static_assert(
                kind == expr_kind::expr_ref ||
        ...
        */
        ...
        decltype(auto) argument(Expr && expr, hana::llong<I> i)
        {
            ...
            static_assert(
                kind == expr_kind::expr_ref ||
                    (0 <= I &&
                     I < decltype(hana::size(expr.elements))::value - 1),
        ...
        */
        ...
        auto make_expression_function(Expr && expr)
        {
            ...
            using stored_type = detail::
                operand_type_t<detail::expression_function_expr, Expr &&>;
            return expression_function<stored_type>{
                detail::make_operand<stored_type>{}(
                    static_cast<Expr &&>(expr))};
        }
    }
}
