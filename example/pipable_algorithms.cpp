...
// want to write out the three member functions generated by this macro, and
// add SFINAE or concepts constraints on the right template parameter.
...
struct algorithm
{
    ...
    BOOST_YAP_USER_CALL_OPERATOR(::algorithm_expr)
};
